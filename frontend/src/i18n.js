...
const messages = {
  en: {
    ...
    'community.your_id': 'Your ID',
    'community.copy_id': 'Copy ID to share',
    'community.enter_user_id': 'Enter user ID',
    'community.chats': 'Chats',
    'community.groups': 'Groups',
    'community.online': 'Online',
    'community.offline': 'Offline',
    'community.typing': 'typing...',
    'community.no_chat_selected': 'No chat selected',
    'community.select_chat_to_start': 'Select a chat to start messaging',
    'community.type_message': 'Type a message...',
    'community.send': 'Send',
    'community.add_connection': 'Add Connection',
    'community.connection_request_sent': 'Connection request sent',
    'community.message': 'Message',
    'community.call': 'Call',
    'community.video_call': 'Video Call',
    'community.search_placeholder': 'Search messages or users',
    'community.no_connections': 'No connections yet. Add some friends to get started!',
    'community.recent': 'Recent',
    'community.unread': 'unread',
    'community.new_message': 'New message',
    'community.message_placeholder': 'Write a message...',
    'community.attachments': 'Attachments',
    'community.emoji': 'Emoji',
    'community.gifs': 'GIFs',
